...
from .minicpm import convert_minicpm_to_hf
from .minicpm5_moe import convert_minicpm5_moe_to_hf
...
def _convert_to_hf_core(args, model_name, name, param):
    ...
    elif "minicpm5" in model_name and "moe" in model_name:
        converted_named_tensors = convert_minicpm5_moe_to_hf(args, name, param)
    elif "minicpm" in model_name:
        converted_named_tensors = convert_minicpm_to_hf(args, name, param)
    else:
